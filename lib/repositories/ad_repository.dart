...
class AdRepository {
  ...
  Future<void> save(Ad ad) async {
    try {
      ...
      adObject.set<dynamic>(keyAdTitle, ad.title);
      adObject.set<dynamic>(keyAdDescription, ad.description);
      adObject.set<bool>(keyAdHidePhone, ad.hidePhone);
      adObject.set<dynamic>(keyAdPrice, ad.price);
      adObject.set<int>(keyAdStatus, ad.status.index);

      adObject.set<dynamic>(keyAdDistrict, ad.address!.district);
      adObject.set<dynamic>(keyAdCity, ad.address!.city!.nome);
      adObject.set<dynamic>(keyAdFederativeUnit, ad.address!.uf!.sigla);
      adObject.set<dynamic>(keyAdPostalCode, ad.address!.cep);
